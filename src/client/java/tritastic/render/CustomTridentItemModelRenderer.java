...
public class CustomTridentItemModelRenderer implements SpecialModelRenderer<Identifier> {
    ...
    @Override
    public void render(Identifier data, ItemDisplayContext displayContext, MatrixStack matrices, OrderedRenderCommandQueue queue, int light, int overlay, boolean glint, int i) {
        matrices.push();
